"""Configuration schema, validation, and loading for Hawzhin VoiceClean."""
...
from voiceclean.errors import ConfigError
...
def load_config(path: Path | str | None = None, is_production: bool = True) -> VoiceCleanConfig:
    ...
    try:
        config = VoiceCleanConfig.model_validate(data)
    except Exception as e:
