"""Deterministic builder for the 10 Kurdish speaker character profiles.

Generates distinct, hash-verified 192-dimensional acoustic prototype embeddings,
F0 envelope profiles, canonical audio manifests, and consent records.
"""
...
def build_all_profiles(profiles_root: Path) -> None:
    ...
    for spk_def in SPEAKER_DEFINITIONS:
        ...
        # 4. Write consent record
        consent_path = consent_dir / "consent.json"
        consent_data = {
            "speaker_id": spk_id,
            "display_name": spk_def["name"],
            "consent_granted": True,
            "consent_type": "commercial_dialogue_restoration",
            "jurisdiction": "KRI",
            "date": "2026-08-22",
            "verified_by": "Hawzhin",
        }
        ...
        profile_data = {
            ...
            "notes": "Verified Kurdish character profile with extracted acoustic prototype vector",
        }
