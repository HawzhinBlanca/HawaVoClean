...
| True-10 plan | 18/34 tasks have current completion proof |
| Last full local gate | Historical schema 1 proof passed on `2b93176d735d746ebfc5865e7c40f2d36e5f5a3a`; 2 isolated passes × 41 steps |
...
| Reproduced release identities | Historical schema 1: wheel, sdist, UI, Resolve engine/plugin, container, SBOM and engineering-audio identities matched; no packaged desktop app identity was captured |
